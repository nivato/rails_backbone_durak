...
class RailsBackboneDurak.Views.Table.TableView extends Backbone.View
  ...
  addAll: () =>
    attacker_view = new RailsBackboneDurak.Views.AttackerCards.Attacker(attackerCards: @options.attacker_cards)
    defender_view = new RailsBackboneDurak.Views.DefenderCards.Defender(defenderCards: @options.defender_cards)
